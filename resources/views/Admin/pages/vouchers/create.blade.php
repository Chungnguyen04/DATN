            ...
            <div class="col-xxl-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Thêm mới voucher</h4>
                    </div>
                    <!-- end card header -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('vouchers.store') }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="live-preview">
                                ...
                                <div class="col-md-12 mb-3 discount_min_price-div" style="display: none">
                                    <label for="categoryInput" class="form-label">Giá trị đơn hàng tối thiểu</label>
                                    <div class="input-group">
                                        <span class="input-group-text">VND</span>
                                        <input type="number" value="{{ old('discount_min_price') }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        <input type="radio" value="condition"
                                            {{ old('discount_type') == 'condition' ? 'checked' : '' }}
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" value="{{ old('total_uses') }}" class="form-control total_uses"
                                        name="total_uses" id="total_uses" placeholder="Nhập số lượt sử dụng...">
                                    @error('total_uses')
                                        <span class="text-danger mt-3">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 mt-3">
                                    <div class="text-start">
                                        <button type="submit" class="btn btn-primary insertCategory">Thêm
                                            voucher</button>
